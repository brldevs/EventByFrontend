...
function addorganizers() {
  ...
  const onSubmit = async (d) => {
    ...
    if (event_id) {
      ...
      alert.show("Co-org, Speaker, Sponsor Added Successfully!");
        ...
        <div className="bg-white mt-4  border-radius-10">
          ...
          <div className="dashboard_event_container pb-5">
            <h2 className="text-center">
              Add Co-Organizers, Sponsors, Speakers & More
            </h2>
            <p className="text-gray-2 text-center mb-5">
              Add or remove event co-organizers, sponsors and speakers
            </p>
            <div className="pb-5">
              <Row>
                <Col className="col-md-10 mx-md-auto">
                  {/* CoOrgSponsorSpeakerForm COMPONENT START */}
                  <CoOrganizer eventId={eventId} />
